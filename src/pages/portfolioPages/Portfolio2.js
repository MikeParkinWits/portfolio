          ...
          <article>
            ...
            <section className="portfolio-page-contents e-content">
              ...
              <p>
                ...
                them. To do this, I aimed to use my entire website as a canvas
                for my artwork; subverting the users preconceived, desensitized,
              ...
              <p>
                I then began to explore various different websites in order to
                understand where to start with my idea; and while I came across
                multiple different areas that I could have explored, one in
                particular stood out to me the most, as it is an area that has
                become normalized, but should not be – cookie consent popups. To
                understand why these should not be normalized, however, we must
                first understand what cookies are. According to Kaspersky
                Antivirus, cookies are a small piece of identifying information
                that is saved to your browser, allowing information to be
                retained between browsing sessions. Although, while these may be
                useful, with first party cookies from the website you are
                visiting used to keep you logged in and remember your
                preferences; they are often abused through third party cookies,
                which are used to track your movement on the web – serving you
                more accurate, and increasingly creepier, advertisements in
                addition unwanted spam. As such, governments around the world
                have begun implementing laws to combat this – with one of the
                most prominent being the ePrivacy Directive put in place by the
                EU in 2002, which requires websites to ask for consent before
                using cookies. Although, while this may appear to be a good idea
                on the surface, loose wording, and very little enforcement, has
                led to it being grossly abused and misused. In the law, it
                states that the methods for giving information, offering a right
                to refuse or requesting consent, should be made as user-friendly
                as possible; however, many websites have taken this liberally,
                which has resulted in websites making use of dark UI/UX patterns
                – which Arushi Jaiswal, in their article Dark patterns in UX,
                notes are deceptive UI/UX interactions that are designed to
                mislead and trick users – to make accepting cookie usage easy,
                but declining it extremely difficult.
              </p>
              ...
              <p>
                As such, I started by focusing on this idea of using dark UI/UX
                patterns, alongside satirical phrasing, to bring attention to
                the abusive nature of cookie consent law. To do this, I began by
                placing a simple cookie consent banner at the bottom of my
                website, purposefully adjusting the colours of the buttons for
                ‘accept all’ and ‘update preferences’ to make users perceive the
                ‘accept all’ button as the right option – with the accept all
                button being an extremely bright, and friendly, colour; as
                opposed to the dull, and slightly opaque, colours of the ‘update
                preferences’ button. In addition to this, the cookie consent
                banner also makes use of more satirical, literal, information as
                to why the website needs you to accept the cookies. This is then
                juxtaposed next to the, often-vague, information claiming
                cookies provide an enhanced user experience, with a line struck
                through the true reason the developers want you to accept their
                ...
                schemes. In addition to this, I also take it a step further –
                ...
                these cookie consent popups can be abused, while still
                technically being legal, and why they should not be normalized.
              </p>
              ...
              <p>
                ...
                to note that the login/logout process for the website also makes
                use of its own deceptive design, the roach motel – which is a
                process whereby providing information is easy, but relinquishing
              ...
              <p>
                ...
                that I wanted to shed light on through my internet artwork – web
                notifications. While their introduction to the web was logical
                and useful, providing users with relevant information without
                having to constantly check the site, they quickly began to be
                misused because of their loose permission principles and ability
                to draw users attention – such as through advertisements and
                spam content at any time. As a result, many people accept them
              ...
              <h3 className="portfolio-page-heading-2">
                2.4. Confirm Shamming
              </h3>

              <p>
                Although, while I had intended to stop my net art with those
                three areas, I soon realized that my net art did not affect the
                users experience of the entire website – as most of the net art
                only appeared at the very beginning of a user’s journey on my
                ...
                mailing list. However, unlike traditional confirm shaming, on
                subscribing the user is emailed to inform them about confirm
                shaming and to teach them about these tactics so that they can
                be more aware.
              </p>
              ...
              <p>
                ...
                piece to it – the ability to toggle the internet artwork on and
                off using a button in the footer of the website. While this may
                seem unnecessary to some, granting the user the ability to
                disable the internet artwork is vital – as it allows the user to
                experience the website without any distractions, making it clear
                just how badly deceptive design tactics impact a websites
                usability and experience. Ultimately, this option then helps to
                highlight the importance of becoming re-sensitized to these
                deceptive design principles across the web, and brings us one
                step closer to outlawing them as a collective.
              </p>
              ...
              <p>
                ...
                deliberate. However, even though I am happy with how the artwork
                turned out, and see it as a success, there were still areas
                where I felt it could have been improved. I found that my
                implementation of a notification system did not meet my overall
                expectations and was not as effective as I expected – as it
                turns out companies have been putting external measures in place
                to reduce notification spamming. While unfortunate for my
                internet artwork, it shows how companies are slowly becoming
                more aware of these deceptive design principles and are trying
                to stop them, which ultimately aligns with the goal of my
                internet artwork.
              </p>
            </section>
          </article>
