            ...
            /> */}
              <section className="portfolio-page-contents e-content">
                ...
                <p>
                  ...
                  net art created to critique the increasingly dark design
                  practices that are present on many modern-day websites,
                  practices that we often ignore as we have become extremely
                  desensitized towards them. To do this, I aimed to create a
                  blog/news website, focusing on issues in the web, which acted
                  as the canvas for my artwork; subverting the users
                  preconceived, desensitized, expectations by taking these bad
                  practices and pushing them to their extreme and mocking them,
                  in an attempt to bring awareness to their true intentions.
                  Below I have outlined the process for how I went about
                  creating this internet artwork, and the reasons behind my
                  decisions.
                </p>
                ...
                <p>
                  ...
                  sessions. Although, while these may be useful, with first
                  party cookies from the website you are visiting used to keep
                  you logged in and remember your preferences; they are often
                  abused through third party cookies, which are used to track
                  your movement on the web – serving you more accurate, and
                  increasingly creepier, advertisements in addition unwanted
                  ...
                  article Dark patterns in UX, notes are deceptive UI/UX
                ...
                <p>
                  ...
                  users are more inclined to engage with it (see figure 5
                  ...
                  enabled (see figure 6 below); as well as encouraging the user
                ...
                <p>
                  ...
                  Khindri, in their 2021 article 10 Common Dark Patterns in UX
                  and How to Avoid Them, forced continuity and action is, for
                  example, when you need to enter your email to continue using a
                  website or an app – such as The New York Times requiring you
                  to login just to read an article. So, while many may be
                  unfamiliar with the term, most have experienced forced action
                  in some shape or form on the internet, becoming desensitized
                  to it as a result. However, when looking more closely at it,
                  the question may arise as to why websites even require you to
                  login if something is free. The answer: while the content is
                  monetarily free, you are paying for it with your personal
                  data, and at the expense of your own privacy – as websites are
                  allowed to do with your data as they please. So, for my
                  internet artwork I decided to create a popup that requires the
                  user to login after they have read just one blog post,
                  acknowledging that they are providing the website with their
                  personal data, with no way to ignore this request – similar to
                  that of The New York Times forced action. However, through the
                  ...
                  easy, but relinquishing access to it is difficult. So, while
                  logging in only requires a single button click, logging out
                  presents an additional popup which tries to persuade the user
                  to not log out – utilizing the same button colours and layout
                  as the cookie banner, with no appearing as the ‘correct’
                  option.
                </p>
                ...
                <p>
                  ...
                  extremely satirical. However, I quickly ran into an issue
                  while creating this aspect of the internet artwork. With
                  notification spam becoming a big issue in recent years, not
                  only do less people accept push notifications; but browsers,
                  and operating systems, have begun giving the user the option
                  to block all notifications system wide. As such, this could
                  make my internet artwork less effective – with no way to alter
                  this from the website. So, to counter this I made it so that
                  if the user has blocked notifications, or does not accept push
                  notifications, an in-browser notification appears to still
                  make the push notifications abuse noticeable.
                </p>
